...
class PelaksanaanPendampinganController extends Controller
{
    ...
    public function laporan()
    {
        ...
        $content->with('program_kerja')->where('lembaga_id', $user->pengelolah->lembaga_id);
        ...
        // return $data;
        return view('dashboard.pengelolah.pelaksanaan_pendampingan.laporan', $data);
    }
    ...
    public function export()
    {
        ...
        if ($data->count() == 0) {
            return redirect('manager/pelaksanaan-pendampingan-laporan')->with('error', 'Data Kosong tidak dapat di Export Silahkan Isi DULU BOSS !!');
        }
    ...
    public function laporanBulanan()
    {
        ...
        // return $data;
        return view('dashboard.admin.pelaksanaan_pendampingan.laporan_bulanan', $data);
    }
    ...
    public function laporanBulananExport()
    {
        ...
        if ($data->count() == 0) {
            return redirect('adm/pelaksanaan-pendampingan-laporan-bulanan')->with('error', 'Data Kosong tidak dapat di Export Silahkan Isi DULU BOSS !!');
        }
    ...
    public function laporanTriwulan()
    {
        ...
        // return $data;
        return view('dashboard.admin.pelaksanaan_pendampingan.laporan_triwulan', $data);
    }
    ...
    public function laporanTriwulanExport()
    {
        ...
        if ($data->count() == 0) {
            return redirect('adm/pelaksanaan-pendampingan-laporan-triwulan')->with('error', 'Data Kosong tidak dapat di Export Silahkan Isi DULU BOSS !!');
        }
    ...
    public function laporanTahunan()
    {
        ...
        // return $data;
        return view('dashboard.admin.pelaksanaan_pendampingan.laporan_tahunan', $data);
    }
    ...
    public function laporanTahunanExport()
    {
        ...
        if ($data->count() == 0) {
            return redirect('adm/pelaksanaan-pendampingan-laporan-tahunan')->with('error', 'Data Kosong tidak dapat di Export Silahkan Isi DULU BOSS !!');
        }
