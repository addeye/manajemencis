...
class KumkmController extends Controller
{
    ...
    public function laporan()
    {
        ...
        // return $data;
        return view('dashboard.pengelolah.kumkm.laporan', $data);
    }
    ...
    public function export()
    {
        ...
        if ($data->count() == 0) {
            return redirect('manager/data-kumkm-laporan')->with('error', 'Data Kosong tidak dapat di Export Silahkan Isi DULU BOSS !!');
        }
