...
class KegiatanKonsultanController extends Controller
{
    ...
    public function getAll()
    {
        ...
        $data = [
            ...
            'data' => $this->kegiatankonsultan->getAllByPengelolah(),
        ];
        // return $data;
        return view('dashboard.pengelolah.kegiatan.list', $data);
    }
    ...
    public function addData()
    {
        ...
        // return $data;
        return view('dashboard.pengelolah.kegiatan.add', $data);
    }
    ...
    public function editData($id)
    {
        ...
        return view('dashboard.pengelolah.kegiatan.edit', $data);
    }
    ...
    public function report(Request $request)
    {
        ...
        // return $data;
        return view('dashboard.pengelolah.kegiatan.report', $data);
    }
    ...
    public function getKegiatanKonsultan()
    {
        ...
        return view('dashboard.pengelolah.laporan_kegiatan_ajax', $data);
    }
