...
class KinerjaController extends Controller
{
    ...
    public function index()
    {
        ...
        $kinerjamaster = KinerjaMaster::with('standart_layanan', 'lembaga')->where('cis_lembaga_id', $user->lembaga_id)->get();

        $data = [
            'title' => 'Daftar Kinerja',
            'data' => $kinerjamaster,
        ];
        return view('dashboard.pengelolah.kinerja.list_modul', $data);
    }
    ...
    public function create()
    {
        ...
        // return $data;
        return view('dashboard.pengelolah.kinerja.add_modul', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('adm/kinerja')->with('success', 'Data Kinerja Berhasil Disimpan');
    }
    ...
    public function getListStandartLayanan($tahun)
    {
        ...
        // return $data;
        return view('dashboard.pengelolah.kinerja.add_ajax_modul', $data);
    }
    ...
    public function getListKinerja($tahun)
    {
        ...
        // return $data;
        return view('dashboard.pengelolah.kinerja.list_ajax_modul', $data);
    }
}
