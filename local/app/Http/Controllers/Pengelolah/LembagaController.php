...
class LembagaController extends Controller
{
    ...
    public function profile()
    {
        $data = array(
            ...
            'data' => $this->cislembaga->getLembagaForPengelolah()
        );

        return view('dashboard.pengelolah.lembaga.profil',$data);
    }
    ...
    public function editProfile()
    {
        ...
        return view('dashboard.pengelolah.lembaga.edit',$data);
    }
    ...
    public function doUpdate(Request $request, $id)
    {
        ...
        if($result)
        {
            return redirect('manager/lembaga/profil')->with('info','Data Lembaga Berhasil Diupdate');
        }
    }
...
//        $section = $phpWord->addSection();
        $html = view('dashboard.pengelolah.lembaga.exportword',$data)->render();
//
