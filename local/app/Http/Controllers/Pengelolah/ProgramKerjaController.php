...
class ProgramKerjaController extends Controller
{
    ...
    public function laporan()
    {
        ...
        $content->with('sasaran_program')->where('lembaga_id', $user->pengelolah->lembaga_id);
        ...
        $data = [
            'sasaran_program' => SasaranProgram::with('ukmtable')->where('lembaga_id', $user->pengelolah->lembaga_id)->where('lock', 'Yes')->get(),
            'data' => $content,
            'sasaran_program_id' => $sasaran_program_id,
        ];
        // return $data;
        return view('dashboard.pengelolah.program_kerja.laporan', $data);
    }
    ...
    public function export()
    {
        ...
        if ($data->count() == 0) {
            return redirect('manager/program-kerja-laporan')->with('error', 'Data Kosong tidak dapat di Export Silahkan Isi DULU BOSS !!');
        }
