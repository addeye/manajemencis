...
class SasaranProgramKoperasiController extends Controller
{
    ...
    public function laporan()
    {
        ...
        $content->with('ukmtable')->where('lembaga_id', $user->pengelolah->lembaga_id)->where('ukmtable_type', 'koperasi');
        ...
        return view('dashboard.pengelolah.sasaran_koperasi.laporan', $data);
    }
    ...
    public function export()
    {
        ...
        if ($data->count() == 0) {
            return redirect('manager/sasaran-koperasi-laporan')->with('error', 'Data Kosong tidak dapat di Export Silahkan Isi DULU BOSS !!');
        }
