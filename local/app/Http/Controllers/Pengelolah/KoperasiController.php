...
namespace App\Http\Controllers\Pengelolah;
...
class KoperasiController extends Controller
{
    ...
    public function index()
    {
        ...
        // return $data;
        return view('dashboard.admin.koperasi.list', $data);
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.admin.koperasi.add', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect('adm/koperasi/create')->withErrors($validator)->withInput();
        }
        ...
        if ($detail) {
            return redirect('adm/koperasi')->with('success', 'Data Koperasi Berhasil disimpan');
        }
    }
    ...
    public function show($id)
    {
        ...
        return view('dashboard.admin.koperasi.show', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.admin.koperasi.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), $rules, $messages);
        if ($validator->fails()) {
            return redirect('adm/koperasi')->withErrors($validator)->withInput();
        }
        ...
        if ($koperasi) {
            return redirect('adm/koperasi/' . $id)->with('success', 'Data Koperasi Berhasil disimpan');
        }
    }
    ...
    public function destroy($id)
    {
        ...
        if ($sasaran_count != 0) {
            return redirect('adm/koperasi/' . $id)->with('error', 'Data Koperasi Sudah Terdaftar Sebagai Sasaran Program. Hapus Dari Sasaran Program Dahulu. Hubungi Super Admin');
        }

        $data->delete();

        if ($data) {
            return redirect('adm/koperasi')->with('success', 'Data Koperasi Berhasil dihapus');
        }
    }
    ...
    public function addDetail($koperasi_id)
    {
        ...
        if (!$kop > 0) {
            return redirect('adm/koperasi')->with('success', 'Maaf tidak bisa hubungi Administrator');
        }
        ...
        return view('dashboard.admin.koperasi.add_detail', $data);
    }
    ...
    public function editDetail($koperasi_id, $id)
    {
        ...
        return view('dashboard.admin.koperasi.edit_detail', $data);
    }
    ...
    public function doAddDetail(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), $rules, $messages);
        if ($validator->fails()) {
            return redirect('adm/koperasi-detail-add/' . $request->koperasi_id)->withErrors($validator)->withInput();
        }
        ...
        if ($datakoperasi > 0) {
            return redirect('adm/koperasi-detail-add/' . $request->koperasi_id)->with('error', 'Data tahun ' . $tahun_detail . ' sudah ada, silahkan diupdate data yang sudah ada !! ')->withInput();
        }
        ...
        if ($detail) {
            return redirect('adm/koperasi/' . $request->koperasi_id)->with('success', 'Detail Koperasi Berhasil di tambahkan');
        }
    }
    ...
    public function doEditDetail(Request $request, $koperasi_id, $id)
    {
        ...
        if ($datakoperasi > 0) {
            return redirect('koperasi-detail-edit/' . $request->koperasi_id . '/' . $id)->with('error', 'Data tahun ' . $tahun_detail . ' sudah ada, silahkan diupdate !! ')->withInput();
        }
        ...
        if ($detail) {
            return redirect('adm/koperasi/' . $koperasi_id)->with('success', 'Detail Koperasi Berhasil di update');
        }
    }
    ...
    public function delDetail($id)
    {
        ...
        if ($sasaran_count != 0 and $koperasi_detail_count == 1) {
            return redirect('adm/koperasi/' . $koperasi_id)->with('error', 'Data Koperasi Sudah Terdaftar Sebagai Sasaran Program. Hapus Dari Sasaran Program Dahulu atau Hubungi Super Admin');
        }

        $data->delete();
        if ($data) {
            return redirect('adm/koperasi/' . $koperasi_id)->with('success', 'Detail Koperasi Berhasil dihapus');
        }
    }
    ...
    public function report()
    {
        ...
        // return $data;
        return view('dashboard.admin.koperasi.report', $data);
    }
    ...
    public function laporan()
    {
        ...
        $content->where('lembaga_id', $user->pengelolah->lembaga_id);
        ...
        // return $data;
        return view('dashboard.pengelolah.koperasi.laporan', $data);
    }
    ...
    public function export()
    {
        ...
        if ($data->count() == 0) {
            return redirect('manager/koperasi-laporan')->with('error', 'Data Kosong tidak dapat di Export Silahkan Isi DULU BOSS !!');
        }
