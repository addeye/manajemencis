...
class SasaranProgramUmkmController extends Controller
{
    ...
    public function laporan()
    {
        ...
        $content->with('ukmtable')->where('lembaga_id', $user->pengelolah->lembaga_id)->where('ukmtable_type', 'kumkm');
        ...
        return view('dashboard.pengelolah.sasaran_kumkm.laporan', $data);
    }
    ...
    public function export()
    {
        ...
        $content->where('lembaga_id', $user->pengelolah->lembaga_id)->where('ukmtable_type', 'kumkm');
        ...
        if ($data->count() == 0) {
            return redirect('manager/sasaran-kumkm-laporan')->with('error', 'Data Kosong tidak dapat di Export Silahkan Isi DULU BOSS !!');
        }
