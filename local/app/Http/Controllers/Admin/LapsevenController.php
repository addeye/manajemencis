...
class LapsevenController extends Controller
{
    ...
    public function koperasi(Request $request)
    {
        ...
        // return $data;
        return view('dashboard.admin.lapseven.koperasi', $data);
    }
    ...
    public function koperasiPrint(Request $request)
    {
        ...
        return view('dashboard.admin.lapseven.koperasi_print', $data);
    }
    ...
    public function umkm(Request $request)
    {
        ...
        return view('dashboard.admin.lapseven.umkm', $data);
    }
    ...
    public function umkmPrint(Request $request)
    {
        ...
        return view('dashboard.admin.lapseven.umkm_print', $data);
    }
    ...
    public function sasaranKoperasi(Request $request)
    {
        ...
        return view('dashboard.admin.lapseven.sasaran_koperasi', $data);
    }
    ...
    public function sasaranKoperasiPrint(Request $request)
    {
        ...
        // return $data;
        return view('dashboard.admin.lapseven.sasaran_koperasi_print', $data);
    }
    ...
    public function sasaranUmkm(Request $request)
    {
        ...
        return view('dashboard.admin.lapseven.sasaran_umkm', $data);
    }
    ...
    public function sasaranUmkmPrint(Request $request)
    {
        ...
        return view('dashboard.admin.lapseven.sasaran_umkm_print', $data);
    }
    ...
    public function programKerja(Request $request)
    {
        ...
        // return $data;
        return view('dashboard.admin.lapseven.program_pendampingan', $data);
    }
    ...
    public function programKerjaPrint(Request $request)
    {
        ...
        // return $data;
        return view('dashboard.admin.lapseven.program_pendampingan_print', $data);
    }
    ...
    public function pelaksanaan(Request $request)
    {
        ...
        // return $data;
        return view('dashboard.admin.lapseven.pelaksanaan_pendampingan', $data);
    }
    ...
    public function getContentPelaksanaan(Request $request)
    {
        ...
        return view('dashboard.admin.lapseven.components.conten_pelaksanaan', $data);
    }
    ...
    public function pelaksanaanPrint(Request $request)
    {
        ...
        return view('dashboard.admin.lapseven.pelaksanaan_pendampingan_print', $data);
    }

    public function pelaksanaanFinal()
    {
        return view('dashboard.admin.lapseven.pelaksanaan.index');
    }

    public function pelaksanaanBulanan()
    {
        return view('dashboard.admin.lapseven.pelaksanaan.bulanan');
    }
    ...
    public function pelaksanaanBulananShow(Request $request)
    {
        ...
        return view('dashboard.admin.lapseven.pelaksanaan.bulanan_show', $data);
    }
    ...
    public function pelaksanaanBulananPrint(Request $request)
    {
        ...
        $data['tanggal_print'] = $this->tanggal_indo(date('Y-m-d'));
        return view('dashboard.admin.lapseven.pelaksanaan.bulanan_print', $data);
    }

    public function pelaksanaanTriwulan()
    {
        return view('dashboard.admin.lapseven.pelaksanaan.triwulan');
    }
    ...
    public function pelaksanaanTriwulanShow(Request $request)
    {
        ...
        return view('dashboard.admin.lapseven.pelaksanaan.triwulan_show', $data);
    }
    ...
    public function pelaksanaanTriwulanPrint(Request $request)
    {
        ...
        $data['tanggal_print'] = $this->tanggal_indo(date('Y-m-d'));
        return view('dashboard.admin.lapseven.pelaksanaan.triwulan_print', $data);
    }

    public function pelaksanaanTahunan()
    {
        return view('dashboard.admin.lapseven.pelaksanaan.tahunan');
    }
    ...
    public function pelaksanaanTahunanShow(Request $request)
    {
        ...
        return view('dashboard.admin.lapseven.pelaksanaan.tahunan_show', $data);
    }
    ...
    public function pelaksanaanTahunanPrint(Request $request)
    {
        ...
        $data['tanggal_print'] = $this->tanggal_indo(date('Y-m-d'));
        return view('dashboard.admin.lapseven.pelaksanaan.tahunan_print', $data);
    }
}
