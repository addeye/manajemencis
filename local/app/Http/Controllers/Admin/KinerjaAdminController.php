...
class KinerjaAdminController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.admin.kinerja.list_modul', $data);
    }
    ...
    public function create()
    {
        ...
        // return $data;
        return view('dashboard.admin.kinerja.add_modul', $data);
    }
    ...
    public function getListStandartLayanan($tahun)
    {
        ...
        // return $data;
        return view('dashboard.admin.kinerja.add_ajax_modul', $data);
    }
    ...
    public function getListKinerja($tahun)
    {
        ...
        // return $data;
        return view('dashboard.admin.kinerja.list_ajax_modul', $data);
    }
}
