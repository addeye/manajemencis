...
class ProgramKerjaController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        $pelaksana_count = PelaksanaanPendampingan::where('program_kerja_id', $id)->count();
        if ($pelaksana_count != 0) {
            return redirect('program-kerja')->with('error', 'Program Kerja Sudah Terdaftar Sebagai Pelaksanaan Pendampingan. Hapus Dari Pelaksanaan Pendampingan Dahulu atau Hubungi Admin Kemenkop');
        }
