...
class KumkmController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.konsultan.kumkm.list', $data);
    }
    ...
    public function destroy($id)
    {
        ...
        if ($sasaran_count != 0) {
            return redirect('data-kumkm/' . $id)->with('error', 'Data UMKM Sudah Terdaftar Sebagai Sasaran Program. Hapus Dari Sasaran Program Dahulu atau Hubungi Admin Kemenkop');
        }

        $data->delete();

        if ($data) {
            return redirect('data-kumkm')->with('success', 'Data UMKM Berhasil dihapus');
        }
    }
    ...
    public function delDetail($id)
    {
        ...
        if ($sasaran_count != 0 and $kumkm_detail_count == 1) {
            return redirect('data-kumkm/' . $kumkm_id)->with('error', 'Data UMKM Sudah Terdaftar Sebagai Sasaran Program. Hapus Dari Sasaran Program Dahulu atau Hubungi Super Admin');
        }
    ...
    public function laporan()
    {
        ...
        // return $data;
        return view('dashboard.konsultan.kumkm.laporan', $data);
    }
    ...
    public function export()
    {
        ...
        return Excel::create('Data UMKM ' . date('d-m-Y'), function ($excel) use ($data) {
