<div class="table-responsive">
    <p><a target="_blank" href="{{url('laporan-pelaksanaan-pendampingan-print?tahun='.Request::get('tahun').'&lembaga_id='.Request::get('lembaga_id').'&konsultan_id='.Request::get('konsultan_id').'&kumkm_sasaran_id='.Request::get('kumkm_sasaran_id'))}}" class="btn btn-danger"><i class="fa fa-print"></i> Print</a></p>
