...
@section('script')
<script>
    var _urlbulanan = "{{url('laporan-pelaksanaan-bulanan-final')}}";
    var _urltriwulan = "{{url('laporan-pelaksanaan-triwulan-final')}}";
    var _urltahunan = "{{url('laporan-pelaksanaan-tahunan-final')}}";
    var _urlshowbulanan = "{{url('laporan-pelaksanaan-bulanan-show')}}";
    var _urlshowtriwulan = "{{url('laporan-pelaksanaan-triwulan-show')}}";
    var _urlshowtahunan = "{{url('laporan-pelaksanaan-tahunan-show')}}";
