        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Tambah Program Kerja {{date('Y')}}</h3>
                ...
                <!-- / box Header -->
                <div class="box-body">
                    <form method="post" action="{{ url('program-kerja') }}" class="form-horizontal">
                        {{ csrf_field() }}
                        <div class="form-group {{$errors->has('sasaran_program_id')?'has-error':''}}">
                            ...
                            <div class="col-sm-5">
                                ...
                                @foreach($sasaran_program as $row)
                                    <option value="{{$row->id}}" {{old('sasaran_program_id')==$row->id?'selected':''}}>{{$row->ukmtable->nama_kumkm}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{$errors->has('permasalahan')?'has-error':''}}">
                            ...
                            <div class="col-sm-5">
                                <textarea class="form-control" name="permasalahan" placeholder="Permasalahan...">{{old('permasalahan')}}</textarea>
                        ...
                        <div class="form-group {{$errors->has('proker_pendampingan')?'has-error':''}}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="proker_pendampingan" placeholder="Program Kerja Pendampingan {{date('Y')}}" value="{{old('proker_pendampingan')}}">
                        ...
                        <div class="form-group {{$errors->has('target_capaian')?'has-error':''}}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="target_capaian" placeholder="Target Capaian.." value="{{old('target_capaian')}}">
