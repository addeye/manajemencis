			...
			<div class="box">
				...
				<div class="box-body table-responsive">
					<form class="form-inline" style="padding-bottom: 10px;">
						...
						<a href="{{ url('program-kerja-laporan') }}" class="btn btn-warning"><i class="fa fa-refresh"></i></a>
						<a href="{{ url('program-kerja-export?sasaran_program_id='.$sasaran_program_id) }}" class="btn btn-info"><i class="fa fa-file-excel-o"></i></a>
					</form>
					<div class="">
