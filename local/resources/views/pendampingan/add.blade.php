    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <!-- / box Header -->
                <div class="box-body">
                    <form method="post" action="{{ url('pendampingan') }}" class="form-horizontal">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group {{$errors->has('tanggal_pendampingan')?'has-error':''}}">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group date">
                                    ...
                                    <input type="text" name="tanggal_pendampingan" class="form-control pull-right datepicker" value="{{date('Y-m-d')}}" readonly>
                                </div>
                        ...
                        <div class="form-group {{$errors->has('permasalahan')?'has-error':''}}">
                            ...
                            <div class="col-sm-5">
                                <textarea name="permasalahan" class="form-control" rows="3" placeholder="Permasalahan"></textarea>
                        ...
                        <div class="form-group {{$errors->has('saran_tindakan')?'has-error':''}}">
                            ...
                            <div class="col-sm-5">
                                <textarea name="saran_tindakan" class="form-control" rows="3" placeholder="Saran / tindakan.."></textarea>
                        ...
                        <div class="form-group {{$errors->has('tindak_lanjut')?'has-error':''}}">
                            ...
                            <div class="col-sm-5">
                                <textarea name="tindak_lanjut" class="form-control" rows="3" placeholder="Tindak lanjut.."></textarea>
