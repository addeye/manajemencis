    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <!-- / box Header -->
                <div class="box-body">
                    <form method="post" action="{{ url('standart-layanan/'.$data->id) }}" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="nama" class="form-control" placeholder="Nama Standart Layanan" required value="{{$data->nama}}">
                            </div>
                        </div>
                        <div class="form-group">
