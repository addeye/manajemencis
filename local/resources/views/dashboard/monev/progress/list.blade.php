			...
			<div class="box">
				...
				<div class="box-body table-responsive">
					<form class="form-inline" style="padding-bottom: 10px;">
						...
						<a href="{{ url('laporan-monev/progress') }}" class="btn btn-warning"><i class="fa fa-refresh"></i></a>
						<a href="{{ url('laporan-monev/progress/export?start='.$start.'&end='.$end) }}" class="btn btn-info"><i class="fa fa-file-excel-o"></i></a>
					</form>
					<div class="">
