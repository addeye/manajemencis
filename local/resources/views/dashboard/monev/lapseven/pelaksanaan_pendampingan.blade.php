			...
			<div class="box">
				...
				<div class="box-body table-responsive">
					<form class="form-inline" style="padding-bottom: 10px;">
						...
						<div class="form-group">
							<select id="lembagaId" onchange="showSelectKonsultan(this.value)" class="form-control select2" name="lembaga_id">
...
<script>
	...
	var contentPelaksanaan = "{{url('data-pendampingan/content-pelaksanaan-pendampingan')}}";
	var konsultanId = $('#conten-konsultan').val();
	var kumkmId = $('#conten-kumkm').val();
	var lembagaId = $('#lembagaId').val();
	var tahun = $('#tahun').val();
	var textselect ='';
