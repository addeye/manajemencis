...
<div class="row">
    <div class="col-lg-2 col-xs-6">
            ...
            <div class="small-box bg-aqua">
                ...
                <a href="{{url('database/koperasi')}}" class="small-box-footer"> Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-2 col-xs-6">
            ...
            <div class="small-box bg-green">
                ...
                <a href="{{url('database/umkm')}}" class="small-box-footer"> Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-2 col-xs-6">
            ...
            <div class="small-box bg-yellow">
                ...
                <a href="{{url('data-pendampingan/sasaran/koperasi')}}" class="small-box-footer"> Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-2 col-xs-6">
            ...
            <div class="small-box bg-red">
                ...
                <a href="{{url('data-pendampingan/sasaran/umkm')}}" class="small-box-footer"> Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-2 col-xs-6">
            <!-- small box -->
            <div class="small-box bg-purple">
                ...
                <a href="{{url('data-pendampingan/program-kerja')}}" class="small-box-footer"> Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-2 col-xs-6">
            <!-- small box -->
            <div class="small-box bg-blue">
                ...
                <a href="{{url('data-pendampingan/pelaksanaan')}}" class="small-box-footer"> Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
