        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Tambah Detail Koperasi <b>{{$data->nama_koperasi}}</b></h3>
                ...
                <!-- / box Header -->
                <div class="box-body">
                    <form method="post" action="{{ url('adm/koperasi-detail-add') }}" class="form-horizontal">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group {{$errors->has('tgl_rat_tahun_buku')?'has-error':''}}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="tgl_rat_tahun_buku" placeholder="Tanggal Format DD-MM-YYYY" value="{{old('tgl_rat_tahun_buku')?old('tgl_rat_tahun_buku'):'00-00-0000'}}" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                ...
                                <a href="{{ url('adm/koperasi/'.$data->id) }}" class="btn btn-default">Kembali</a>
                            </div>
                        </div>
                    </form>
                </div>
