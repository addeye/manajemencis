    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <!-- / box Header -->
                <div class="box-body">
                    <form method="post" action="{{ url('data-kumkm-detail/'.$data->kumkm_id.'/'.$data->id) }}" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                ...
                                <a href="{{ url('data-kumkm/'.$data->kumkm_id) }}" class="btn btn-default">Kembali</a>
                            </div>
                        </div>
                    </form>
                </div>
