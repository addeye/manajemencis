<div class="table-responsive">
    <p><a target="_blank" href="{{url('kons/laporan-pelaksanaan-triwulan-print?tahun='.Request::get('tahun').'&triwulan='.Request::get('triwulan').'&konsultan_id='.Request::get('konsultan_id'))}}" class="btn btn-danger"><i class="fa fa-print"></i> Print</a></p>
