		...
		<div class="col-xs-12">
			...
			<div class="box">
				<div class="box-header">
					<h3 class="box-title">Laporan Tahunan Kartu Pelaksanaan Pendampingan Koperasi Dan UMK</h3>
				</div>
				<!-- / box Header -->
				<div class="box-body table-responsive">
					<form class="form-inline" style="padding-bottom: 10px;">
						...
						<a href="{{ url('adm/pelaksanaan-pendampingan-laporan-tahunan') }}" class="btn btn-warning"><i class="fa fa-refresh"></i></a>
						<a href="{{ url('adm/pelaksanaan-pendampingan-laporan-tahunan-export?tahun='.$tahun) }}" class="btn btn-info"><i class="fa fa-file-excel-o"></i></a>
					</form>
						<div class="">
