			...
			<div class="box">
				<div class="box-header">
					...
					<div class="pull-right">
						<a href="{{ url('adm/data-kumkm') }}" class="btn btn-warning btn-xs" data-toggle="tooltip" data-original-title="Kembali"><i class="fa fa-reply"></i></a>
						<a class="btn btn-success btn-xs" href="{{ url('adm/data-kumkm/'.$data->id.'/edit') }}">
						...
						<form id="delete-form-{{$data->id}}" action="{{ url('adm/data-kumkm/'.$data->id) }}" method="POST" style="display: none;">{{ csrf_field() }}
				...
				<div class="box-body">
					...
					<div class="table-responsive">
						...
						<caption>Detail <a class="btn btn-primary btn-xs" href="{{ url('adm/data-kumkm-detail-add/'.$data->id) }}"><i class="fa fa-plus"></i> Tambah</a></caption>
						<tr>
						...
						@foreach ($data->kumkm_detail as $row)
							<tr>
								...
								<td>
									<a href="{{ url('adm/data-kumkm-detail-edit/'.$data->id.'/'.$row->id) }}" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i></a>
				                    ...
				                    <form id="deletedetail-form-{{$row->id}}" action="{{ url('adm/data-kumkm-detail-del/'.$row->id) }}" method="POST" style="display: none;">{{ csrf_field() }}
				                        <input type="hidden" name="_method" value="DELETE">
				                    </form>
								</td>
							</tr>
