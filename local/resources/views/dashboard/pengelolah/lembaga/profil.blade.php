    ...
    <div class="row">
            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools pull-right">
                        <a href="{{ url('/manager/lembaga/export/word/'.$data->id) }}" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="Export Word {{$data->plut_name}}"><i
                                    class="fa fa-file-word-o"></i></a>
                        <a href="{{ url('/manager/lembaga/profil/edit') }}" class="btn btn-success btn-xs" data-toggle="tooltip" data-placement="left" title="Edit Data {{$data->plut_name}}"><i
        ...
        <div class="col-xs-6">
            ...
            <div class="box box-success collapsed-box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form action="{{url('adm/sentra_binaan')}}" method="post">
                        {{ csrf_field() }}
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @foreach($data->sentra_binaan as $row)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('adm/sentra_binaan/'.$row->id.'/delete') }}"
            ...
            <div class="box box-success collapsed-box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form action="{{url('adm/cisfile')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <input type="hidden" name="cis_lembaga_id" value="{{$data->id}}">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @foreach($data->cis_filemanager as $row)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('adm/cisfile/'.$row->id.'/delete') }}"
                                       onclick="return ConfirmDelete()" class="btn btn-danger btn-xs"><i
                                                class="glyphicon glyphicon-trash"></i></a>
                                </td>
                            </tr>
