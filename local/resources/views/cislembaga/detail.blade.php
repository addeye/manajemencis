    ...
    <div class="row">
            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools pull-right">
                        <a href="{{ url('cislembaga/'.$data->id) }}" class="btn btn-success btn-xs"><i
        ...
        <div class="col-xs-6">
            ...
            <div class="box box-success collapsed-box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form action="{{url('sentra_binaan')}}" method="post">
                        {{ csrf_field() }}
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @foreach($data->sentra_binaan as $row)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('sentra_binaan/'.$row->id.'/delete') }}"
            ...
            <div class="box box-success collapsed-box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form action="{{url('cisfile')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <input type="hidden" name="cis_lembaga_id" value="{{$data->id}}">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @foreach($data->cis_filemanager as $row)
                            <tr>
                                <td>{{$row->id}}</td>
                                <td>{{$row->tipe}}</td>
                                <td><a href="{{url('image/'.$row->photo)}}"><img width="30" class="img-responsive" src="{{url('image/'.$row->photo)}}"></a></td>
                                <td>
                                    <a href="{{ url('cisfile/'.$row->id.'/delete') }}"
                                       onclick="return ConfirmDelete()" class="btn btn-danger btn-xs"><i
                                                class="glyphicon glyphicon-trash"></i></a>
                                </td>
                            </tr>
