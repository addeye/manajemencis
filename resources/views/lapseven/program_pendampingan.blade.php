			...
			<div class="box">
				...
				<div class="box-body table-responsive">
					<form class="form-inline" style="padding-bottom: 10px;">
                        ...
                        @if (!is_null(Request::get('lembaga_id')))
							<div class="form-group">
                    ...
                    @if (Request::get('tahun') && Request::get('lembaga_id') && Request::get('sasaran_program_id'))
                <div class="table-responsive">
                    <p><a target="_blank" href="{{url('laporan-program-pendampingan-print?tahun='.Request::get('tahun').'&lembaga_id='.Request::get('lembaga_id').'&sasaran_program_id='.Request::get('sasaran_program_id'))}}" class="btn btn-danger"><i class="fa fa-print"></i> Print</a></p>
