    ...
    <div class="col-lg-2 col-xs-6">
        ...
        <div class="col-lg-2 col-xs-6">
            ...
            <div class="small-box bg-yellow">
                ...
                <a href="{{url('sasaran-program-koperasi')}}" class="small-box-footer"> Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-2 col-xs-6">
            ...
            <div class="small-box bg-red">
                ...
                <a href="{{url('sasaran-program-umkm')}}" class="small-box-footer"> Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-2 col-xs-6">
            <!-- small box -->
            <div class="small-box bg-purple">
                ...
                <a href="{{url('program-kerja-pendampingan')}}" class="small-box-footer"> Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-2 col-xs-6">
            <!-- small box -->
            <div class="small-box bg-blue">
                ...
                <a href="{{url('pelaksanaan-pendampingan-konsultan')}}" class="small-box-footer"> Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
