            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-warning btn-xs" href="{{ url('koperasi/'.$data->id) }}">
                ...
                <!-- / box Header -->
                <div class="box-body">
                    <form method="post" action="{{ url('koperasi-detail-add') }}" class="form-horizontal">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group {{$errors->has('tgl_rat_tahun_buku')?'has-error':''}}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="tgl_rat_tahun_buku" placeholder="Tanggal Format DD-MM-YYYY" value="{{old('tgl_rat_tahun_buku')?old('tgl_rat_tahun_buku'):''}}" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask>
