    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <!-- / box Header -->
                <div class="box-body">
                    <form method="post" action="{{ url('koperasi-detail/'.$data->koperasi_id.'/'.$data->id) }}" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                ...
                                <a href="{{ url('koperasi/'.$data->koperasi_id) }}" class="btn btn-default">Kembali</a>
                            </div>
                        </div>
                    </form>
                </div>
