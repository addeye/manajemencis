			...
			<div class="box">
				<div class="box-header">
					...
					<div class="pull-right">
						<a href="{{ url('database-umkm') }}" class="btn btn-warning btn-xs" data-toggle="tooltip" data-original-title="Kembali"><i class="fa fa-reply"></i></a>
				...
				<div class="box-body">
					...
					<div class="table-responsive">
						...
						<caption>Detail
							{{-- <a class="btn btn-primary btn-xs" href="{{ url('data-kumkm-detail-add/'.$data->id) }}"><i class="fa fa-plus"></i> Tambah</a> --}}
						</caption>
						<tr>
