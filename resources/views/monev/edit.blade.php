    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <h3 class="box-title">Perbaruhi Akun Monev</h3>
                </div>
                <!-- / box Header -->
                <div class="box-body">
                    @include('layouts.alert')
                    <form method="post" action="{{ url('monev/'.$data->id) }}" class="form-horizontal">
                        <input type="hidden" name="_method" value="PUT">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">Nama Lengkap</label>
                            <div class="col-sm-5">
                                <input type="text" name="name" class="form-control" placeholder="Nama lengkap akun.." value="{{$data->name}}">
                            </div>
                        </div>
                        <div class="form-group">
