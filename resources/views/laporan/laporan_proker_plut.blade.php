...
@section('content')
    ...
    <div class="col-xs-12">
            <div class="box">
                <div class="box-body">
                    <form class="form-inline" action="{{url('laporan-proker-plut')}}" method="get">
                        ...
                        <a href="{{ url('laporan-proker-plut/excel?lembaga_id='.$lembaga_id) }}" class="btn btn-success">Export Excel</a>
                    </form>
                </div>
            </div>
        </div>
