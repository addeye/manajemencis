<div class="table-responsive">
    <p><a target="_blank" href="{{url('data-pendampingan/laporan-pelaksanaan-tahunan-print?tahun='.Request::get('tahun').'&lembaga_id='.Request::get('lembaga_id').'&konsultan_id='.Request::get('konsultan_id'))}}" class="btn btn-danger"><i class="fa fa-print"></i> Print</a></p>
