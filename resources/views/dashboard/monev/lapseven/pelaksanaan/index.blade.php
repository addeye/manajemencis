...
@section('script')
<script>
    var _urlbulanan = "{{url('data-pendampingan/laporan-pelaksanaan-bulanan-final')}}";
    var _urltriwulan = "{{url('data-pendampingan/laporan-pelaksanaan-triwulan-final')}}";
    var _urltahunan = "{{url('data-pendampingan/laporan-pelaksanaan-tahunan-final')}}";
    var _urlshowbulanan = "{{url('data-pendampingan/laporan-pelaksanaan-bulanan-show')}}";
    var _urlshowtriwulan = "{{url('data-pendampingan/laporan-pelaksanaan-triwulan-show')}}";
    var _urlshowtahunan = "{{url('data-pendampingan/laporan-pelaksanaan-tahunan-show')}}";
    ...
    function showSelectKonsultan(lembaga_id)
	{
		$('#conten-konsultan').html('<option value="">Pilih Konsultan</option>');
		$.ajax({
            url: konsultanselect+'/'+lembaga_id,
            type: "GET",
