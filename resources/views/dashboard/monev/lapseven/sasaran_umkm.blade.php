		...
		<div class="col-xs-12">
			...
			<div class="box">
                ...
                <div class="table-responsive">
                    <p><a target="_blank" href="{{url('laporan-pendampingan-sasaran-umkm-print?tahun='.Request::get('tahun').'&lembaga_id='.Request::get('lembaga_id'))}}" class="btn btn-danger"><i class="fa fa-print"></i> Print</a></p>
