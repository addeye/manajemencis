<div class="table-responsive">
    <p><a target="_blank" href="{{url('adm/laporan-pelaksanaan-pendampingan-print?tahun='.Request::get('tahun').'&konsultan_id='.Request::get('konsultan_id').'&kumkm_sasaran_id='.Request::get('kumkm_sasaran_id'))}}" class="btn btn-danger"><i class="fa fa-print"></i> Print</a></p>
