		...
		<div class="col-xs-12">
			...
			<div class="box">
                ...
                <div class="table-responsive">
                    <p><a target="_blank" href="{{url('adm/laporan-pendampingan-sasaran-koperasi-print?tahun='.Request::get('tahun'))}}" class="btn btn-danger"><i class="fa fa-print"></i> Print</a></p>
