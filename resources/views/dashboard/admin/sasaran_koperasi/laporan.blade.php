			...
			<div class="box">
				...
				<div class="box-body table-responsive">
					<form class="form-inline" style="padding-bottom: 10px;">
						...
						<a href="{{ url('adm/sasaran-koperasi-export?tahun='.$tahun) }}" class="btn btn-info"><i class="fa fa-file-excel-o"></i></a>
					</form>
					<div class="">
							...
							<tbody>
								...
								@foreach ($data as $row)
									<tr>
										...
										<td>{{isset($row->ukmtable->koperasi_detail[0])?number_format($row->ukmtable->koperasi_detail[0]->volume_usaha):''}}</td>
