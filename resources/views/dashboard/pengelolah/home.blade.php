...
<div class="row">
    <div class="col-lg-2 col-xs-6">
            ...
            <div class="small-box bg-aqua">
                ...
                <a href="{{url('manager/koperasi')}}" class="small-box-footer"> Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-2 col-xs-6">
            ...
            <div class="small-box bg-green">
                ...
                <a href="{{url('manager/data-kumkm')}}" class="small-box-footer"> Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-2 col-xs-6">
            ...
            <div class="small-box bg-yellow">
                ...
                <a href="{{url('manager/sasaran-koperasi')}}" class="small-box-footer"> Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-2 col-xs-6">
            ...
            <div class="small-box bg-red">
                ...
                <a href="{{url('manager/sasaran-kumkm')}}" class="small-box-footer"> Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-2 col-xs-6">
            <!-- small box -->
            <div class="small-box bg-purple">
                ...
                <a href="{{url('manager/program-kerja')}}" class="small-box-footer"> Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-2 col-xs-6">
            <!-- small box -->
            <div class="small-box bg-blue">
                ...
                <a href="{{url('manager/pelaksanaan-pendampingan')}}" class="small-box-footer"> Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
