		...
		<div class="col-xs-12">
			...
			<div class="box">
                ...
                <div class="table-responsive">
                    <p><a target="_blank" href="{{url('manager/laporan-program-pendampingan-print?tahun='.Request::get('tahun').'&sasaran_program_id='.Request::get('sasaran_program_id'))}}" class="btn btn-danger"><i class="fa fa-print"></i> Print</a></p>
