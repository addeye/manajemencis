<div class="table-responsive">
    <p><a target="_blank" href="{{url('admin/laporan-pelaksanaan-bulanan-print?tahun='.Request::get('tahun').'&bulan='.Request::get('bulan').'&konsultan_id='.Request::get('konsultan_id'))}}" class="btn btn-danger"><i class="fa fa-print"></i> Print</a></p>
