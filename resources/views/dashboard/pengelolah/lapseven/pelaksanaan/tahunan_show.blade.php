<div class="table-responsive">
    <p><a target="_blank" href="{{url('admin/laporan-pelaksanaan-tahunan-print?tahun='.Request::get('tahun').'&konsultan_id='.Request::get('konsultan_id'))}}" class="btn btn-danger"><i class="fa fa-print"></i> Print</a></p>
