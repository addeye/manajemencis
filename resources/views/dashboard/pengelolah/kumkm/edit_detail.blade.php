        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Edit Detail UMKM</h3>
                </div>
                <!-- / box Header -->
                <div class="box-body">
                    <form method="post" action="{{ url('adm/data-kumkm-detail/'.$data->kumkm_id.'/'.$data->id) }}" class="form-horizontal">
                        ...
                        <div class="form-group {{$errors->has('modal_sendiri')?'has-error':''}}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="modal_sendiri" placeholder="Jumlah Modal Sendiri" value="{{$data->modal_sendiri}}">
                        ...
                        <div class="form-group {{$errors->has('modal_hutang')?'has-error':''}}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="modal_hutang" placeholder="Jumlah Modal Luar" value="{{$data->modal_hutang}}">
                        ...
                        <div class="form-group {{$errors->has('asset')?'has-error':''}}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="asset" placeholder="Jumlah Asset" value="{{$data->asset}}">
                        ...
                        <div class="form-group {{$errors->has('omset')?'has-error':''}}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="omset" placeholder="Jumlah Omset" value="{{$data->omset}}">
                        ...
                        <div class="form-group {{$errors->has('kegiatan_usaha')?'has-error':''}}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="kegiatan_usaha" placeholder="Kegiatan Usaha UMKM" value="{{$data->kegiatan_usaha}}">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                ...
                                <a href="{{ url('adm/data-kumkm/'.$data->kumkm_id) }}" class="btn btn-default">Kembali</a>
                            </div>
                        </div>
                    </form>
                </div>
