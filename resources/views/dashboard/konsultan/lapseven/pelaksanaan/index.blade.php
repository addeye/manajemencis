...
@section('script')
<script>
    var _urlbulanan = "{{url('kons/laporan-pelaksanaan-bulanan-final')}}";
    var _urltriwulan = "{{url('kons/laporan-pelaksanaan-triwulan-final')}}";
    var _urltahunan = "{{url('kons/laporan-pelaksanaan-tahunan-final')}}";
    var _urlshowbulanan = "{{url('kons/laporan-pelaksanaan-bulanan-show')}}";
    var _urlshowtriwulan = "{{url('kons/laporan-pelaksanaan-triwulan-show')}}";
    var _urlshowtahunan = "{{url('kons/laporan-pelaksanaan-tahunan-show')}}";
